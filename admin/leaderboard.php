...
$select_top_vote = mysqli_query($db_conn,"SELECT candidates.candidate_name, COUNT(votes.vote_id) as vote_count
FROM candidates
...
<div class="leaderboard">
  ...
  <ol>
  <?php while($row = mysqli_fetch_assoc($select_top_vote)) : ?>
  <li>
      <mark><?=  $row['candidate_name']?></mark>
      <small><?= $row['vote_count'] ?> Votes</small>
    </li>
   <?php endwhile; ?>
  </ol>
</div>

<a href="dashboard.php" class="btn-dark">Back To Dashboard</a>
